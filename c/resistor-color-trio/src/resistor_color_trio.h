...
// resistance values.
//
// Each band acts as a digit of a number. For example, if they printed a
// brown band (value 1) followed by a green band (value 5), it would translate
// to the number 15. In this exercise, you are going to create a helpful
// program so that you don't have to remember the values of the bands.
// The program will take 3 colors as input, and outputs the correct value,
// in ohms. The color bands are encoded as follows:
// Black: 0
// Brown: 1
// Red: 2
// Orange: 3
...
// (If Math is your thing, you may want to think of the zeros as exponents
// of 10. If Math is not your thing, go with the zeros. It really is the same
...
// saying "kilometer" for 1000 meters, and "kilograms" for 1000 grams. So an
// input of "orange", "orange", "orange" should return:
// "33 kiloohms"
